...
import com.draaisa.controller.PrestadorServicioController;
...
public class PrestadorServicioView extends Application {
    ...
    private void actualizarTablaFiltro(List<PrestadorServicio> prestadoresFiltrados) {
        ObservableList<PrestadorServicio> observablePrestadores = FXCollections.observableArrayList(prestadoresFiltrados);
